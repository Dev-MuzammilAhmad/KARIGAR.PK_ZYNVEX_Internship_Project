...
const steps = [
  {
    number: '01',
    title: 'Search',
    description: 'Browse skilled workers by category, location, and budget. Find the right match for your needs.',
    icon: (
  ...
  },
  {
    number: '02',
    title: 'Connect',
    description: 'View profiles, ratings, and reviews. Contact workers directly via WhatsApp or phone call.',
    icon: (
      <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
  ...
  },
  {
    number: '03',
    title: 'Get It Done',
    description: 'Hire with confidence. No middlemen, no commissions — just direct service from skilled professionals.',
    icon: (
      <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
    ...
    <div>
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="absolute inset-0 pointer-events-none">
          <div className="absolute top-20 right-10 w-72 h-72 bg-primary-light/40 rounded-full blur-3xl" />
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 sm:py-28 lg:py-36">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <div className="inline-flex items-center gap-2 px-4 py-1.5 bg-primary-light rounded-full mb-6">
              ...
              <span className="text-sm font-medium text-primary">Pakistan&apos;s Local Service Marketplace</span>
            </div>

            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-text-primary leading-tight tracking-tight">
              Find Trusted{' '}
              <span className="text-primary">Local Workers</span>{' '}
              Near You
            </h1>

            <p className="mt-6 text-lg sm:text-xl text-text-secondary max-w-2xl mx-auto leading-relaxed">
              Connect directly with skilled electricians, plumbers, carpenters, and more in your area.
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="mt-4 text-text-secondary max-w-xl mx-auto text-lg">
              Hiring a skilled worker is just three easy steps away
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8 lg:gap-12">
            {steps.map((step) => (
              <div
                key={step.number}
                className="relative bg-surface border border-border rounded-2xl p-8 text-center hover:shadow-lg hover:border-primary/20 hover:-translate-y-1 transition-all duration-300 group"
              >
                {/* Step number badge */}
                <div className="inline-flex items-center justify-center w-14 h-14 bg-primary-light rounded-2xl mb-6 group-hover:bg-primary group-hover:text-white text-primary transition-colors duration-300">
                  {step.icon}
                </div>
                <div className="absolute top-4 right-4 text-4xl font-bold text-border/60 select-none">
                  {step.number}
                </div>
      ...
      <section className="py-20 sm:py-24 bg-surface border-y border-border">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="mt-4 text-text-secondary max-w-xl mx-auto text-lg">
              Explore the most in-demand services available on Karigar.pk
            </p>
          </div>
          ...
          <div className="relative bg-primary rounded-3xl overflow-hidden">
            ...
            <div className="relative px-8 py-16 sm:px-16 sm:py-20 text-center">
              ...
              <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                <Link
                  to="/signup"
                  className="w-full sm:w-auto px-8 py-3.5 text-base font-semibold text-primary bg-white rounded-xl hover:bg-primary-light shadow-md hover:shadow-lg transform hover:-translate-y-0.5 transition-all"
                >
                  Create Free Account
                </Link>
                <Link
                  to="/login"
                  className="w-full sm:w-auto px-8 py-3.5 text-base font-semibold text-white border-2 border-white/30 rounded-xl hover:bg-white/10 hover:border-white/50 transition-all"
                >
                  Sign In
                </Link>
              </div>
