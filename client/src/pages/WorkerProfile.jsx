    ...
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
      ...
      <div className="bg-surface border border-border rounded-2xl overflow-hidden shadow-sm">
        ...
        <div className="border-t border-border px-6 sm:px-8 py-6">
          ...
          <div className="flex flex-wrap gap-3">
            ...
            {userPhone && (
              <a
                ...
                className="inline-flex items-center gap-2 px-5 py-2.5 bg-green-600 text-white rounded-xl font-medium text-sm hover:bg-green-700 shadow-sm hover:shadow transition-all"
              >
            ...
            {userPhone && (
              <a
                href={`tel:${userPhone}`}
                className="inline-flex items-center gap-2 px-5 py-2.5 bg-primary text-white rounded-xl font-medium text-sm hover:bg-primary-hover shadow-sm hover:shadow transition-all"
              >
            ...
            {userEmail && (
              <a
                ...
                className="inline-flex items-center gap-2 px-5 py-2.5 border border-border text-text-primary rounded-xl font-medium text-sm hover:bg-background hover:border-primary/30 transition-all"
              >
                <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
          ...
          {!userPhone && !userEmail && (
            <p className="text-text-secondary text-sm">No contact information available.</p>
          )}
        </div>
      </div>
    </div>
